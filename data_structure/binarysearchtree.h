...
protected:
	...
	virtual BinaryTreeNode<Key, Value>* insertHelper(
			BinaryTreeNode<Key, Value>*, const Key& key, const Value& value);
	...
	virtual BinaryTreeNode<Key, Value>* removeHelper(
			BinaryTreeNode<Key, Value>*, const Key& key,
	 ...
	 */
	virtual int findHelper(BinaryTreeNode<Key, Value>*, const Key& key,
			Value& value);
	 ...
	 * @returns   outpustream
	 */
	virtual std::ostream& outputHelper(std::ostream& os,
