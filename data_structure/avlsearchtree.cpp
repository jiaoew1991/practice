...
BinaryTreeNode<Key, Value>* AVLSearchTree<Key, Value>::insertHelper(
...
template<class Key, class Value>
BinaryTreeNode<Key, Value>* AVLSearchTree<Key, Value>::deleteMin(
...
template<class Key, class Value>
BinaryTreeNode<Key, Value>* AVLSearchTree<Key, Value>::adjustTree(
		AVLTreeNode<Key, Value>* subRoot)
{
	...
	{ // it is okay, don't need adjust
		return subRoot;
	}
	else if (leftH - rightH > 1)
	{ // left subtree's height is too large
